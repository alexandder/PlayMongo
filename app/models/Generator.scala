...
object Generator {
  ...
  val maleNames = fromFile("maleNames.txt").getLines.toList
  val femaleNames = fromFile("femaleNames.txt").getLines.toList
  val surnames = fromFile("lastNames.txt").getLines.toList
  val locations = fromFile("locations.txt").getLines.toList
